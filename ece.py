...
if __name__ == '__main__':
    base = 'http://ece.shu.edu.cn'
    table_id = '/Default.aspx?tabid='

    i1 = MyInfo(base, table_id + '35627', "255c2ace-d8ea-48dd-acdb-deceb4aef3fd",
                "dnn:ctr66067:ArticleList:_ctl0:lbtnNext", "dnn_ctr66067_ArticleList__ctl0_plTotalPage")
    i2 = MyInfo(base, table_id + '35629', "8c1aebba-84c5-40fe-a29c-cc61e3a9439e",
                "dnn:ctr66078:ArticleList:_ctl0:lbtnNext", "dnn_ctr66078_ArticleList__ctl0_plTotalPage")
    i3 = MyInfo(base, table_id + '35633', "bf050b64-3b2e-452c-b182-e01015098fd0",
                "dnn:ctr66080:ArticleList:_ctl0:lbtnNext", "dnn_ctr66080_ArticleList__ctl0_plTotalPage")
    i4 = MyInfo(base, table_id + '35634', "e60496cc-f9d9-450c-9fad-5734ede96b6f",
                "dnn:ctr66087:ArticleList:_ctl0:lbtnNext", "dnn_ctr66087_ArticleList__ctl0_plTotalPage")
    i5 = MyInfo(base, table_id + '35635', "4a64150b-8b92-49e0-83d9-924459ef2fc6",
                "dnn:ctr66089:ArticleList:_ctl0:lbtnNext", "dnn_ctr66089_ArticleList__ctl0_plTotalPage")
    # i6 = MyInfo(base, table_id + '35636', "fccbe39e-bd27-4ddd-8fbc-44b16013c681",
    #             "dnn:ctr61619:ArticleList:_ctl0:lbtnNext", "dnn_ctr61619_ArticleList__ctl0_plTotalPage")

repeat_list = [i1, i2, i3, i4, i5]
