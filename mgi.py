...
if __name__ == '__main__':
    base = 'http://www.mgi.shu.edu.cn'
    table_id = '/Default.aspx?tabid='

    i1 = MyInfo(base, table_id + '33137', "255c2ace-d8ea-48dd-acdb-deceb4aef3fd",
                "dnn:ctr61615:ArticleList:_ctl0:lbtnNext", "dnn_ctr61615_ArticleList__ctl0_plTotalPage")
    i2 = MyInfo(base, table_id + '33138', "8c1aebba-84c5-40fe-a29c-cc61e3a9439e",
                "dnn:ctr61609:ArticleList:_ctl0:lbtnNext", "dnn_ctr61609_ArticleList__ctl0_plTotalPage")
    i3 = MyInfo(base, table_id + '38625', "577a7c47-9cbe-480b-b9e4-2379e538c463",
                "dnn:ctr69143:ArticleList:_ctl0:lbtnNext", "dnn_ctr69143_ArticleList__ctl0_plTotalPage")
    i4 = MyInfo(base, table_id + '33139', "49cbe22d-867e-4569-83e3-6d8da970ccb1",
                "dnn:ctr61619:ArticleList:_ctl0:lbtnNext", "dnn_ctr61619_ArticleList__ctl0_plTotalPage")

repeat_list = [i1, i2, i3, i4]
