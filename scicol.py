...
base_url = 'http://www.scicol.shu.edu.cn/'
user_agent = [
...
def get_news_info(soup):
    ...
    for (i, j) in zip(news_list, date_list):
        ...
        para = {"userId": "a65a06a6-8e44-4b4c-8207-6f3f0a32635c", "mediaTitle": i['title'],
                "newsUrl": news_url, "newsLabelId": "5aedfb9d-797a-4a48-85de-05a7c893b480",
...
dnn:ctr64005:ArticleList:_ctl0:lbtnNext
...
'''
    ...
    # TODO 3
    Url = 'http://www.scicol.shu.edu.cn/Default.aspx?tabid=34451'
